...
### BMP-1 (U+0000 - U+3FFF) v4.0.1

* [SVG (29.9 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-1-poster.svg)
* [PNG (17.5 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-1-poster.png)
* [PDF (13.3 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-1-poster.pdf)

### BMP-2 (U+4000 - U+7FFF) v4.0.1

* [SVG (36.3 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-2-poster.svg)
* [PNG (24.6 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-2-poster.png)
* [PDF (15.3 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-2-poster.pdf)

### BMP-3 (U+8000 - U+BFFF) v4.0.1

* [SVG (38.2 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-3-poster.svg)
* [PNG (21.6 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-3-poster.png)
* [PDF (15.0 MB)](https://github.com/eggplants/unicode-map/releases/download/v4.0.1/bmp-3-poster.pdf)
